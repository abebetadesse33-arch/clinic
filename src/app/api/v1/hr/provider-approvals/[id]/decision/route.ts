...
import { db } from "@/db";
import { providerProfiles, providerSchedules, auditLogs } from "@/db/schema";
  ...
  try {
    ...
    try {
      await dispatchNotification({
        ...
        type: action === "approve" ? "profile_approved" : "profile_revision_requested",
        ...
        relatedEntityType: "provider_profiles",

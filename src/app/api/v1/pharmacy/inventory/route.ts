    ...
    if (view === "catalog") {
      ...
      const catalog = await db
        .select({
          ...
          itemCode: drugCatalog.itemCode,
          category: drugCatalog.category,
          sectionNumber: drugCatalog.sectionNumber,
          sectionName: drugCatalog.sectionName,
          isControlled: drugCatalog.isControlled,
          rxOtc: drugCatalog.rxOtc,

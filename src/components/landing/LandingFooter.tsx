...
export function LandingFooter() {
  return (
    <footer className="hidden md:block border-t border-[#E7E2D8] bg-[#0B3B32] text-white pt-16 pb-12 px-4 sm:px-8 max-w-7xl mx-auto rounded-t-3xl mt-12">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12 text-xs">
        {/* Column 1: Brand & Contact */}
        <div className="col-span-2 space-y-4">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-xl bg-white text-[#005C4B] flex items-center justify-center font-bold shadow-sm">
              <HeartPulse className="w-5 h-5" />
            </div>
            <span className="font-extrabold text-white text-base tracking-tight font-display">
              NiniMed One Medical Network
            </span>
          </div>
          <p className="text-[#E8F4F0]/80 text-xs leading-relaxed max-w-sm">
          ...
          <div className="space-y-1.5 text-[#E8F4F0]/70 text-xs">
        ...
        <div className="space-y-2.5">
          <span className="text-[11px] font-bold uppercase tracking-wider text-[#E5A93C] block">Services</span>
          <ul className="space-y-2 text-[#E8F4F0]/80">
        ...
        {/* Column 3: Membership */}
        <div className="space-y-2.5">
          <span className="text-[11px] font-bold uppercase tracking-wider text-[#E5A93C] block">Membership</span>
          <ul className="space-y-2 text-[#E8F4F0]/80">
        ...
        <div className="space-y-2.5">
          <span className="text-[11px] font-bold uppercase tracking-wider text-[#E5A93C] block">Accreditation</span>
          <ul className="space-y-2 text-[#E8F4F0]/80 text-[11px]">
      ...
      <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-[#E8F4F0]/60">
